...
I18N = {
    "zh": {
        ...
        "report_dep_missing": "当前环境缺少图表报表依赖，已切换为基础报表导出（不含图表）。",
        "pod_review": "POD审核测试",
        "delivered": "已妥投",
    ...
    "en": {
        ...
        "report_dep_missing": "Chart/report dependency is missing in current environment; switched to basic report export (without charts).",
