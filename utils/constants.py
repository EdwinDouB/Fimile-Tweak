...
I18N = {
    "zh": {
        ...
        "manual_hub_label": "手动填写 Unknown Hub 名称",
        "manual_hub_placeholder": "例如：ONT",
        "manual_contractor_label": "手动填写 Unknown Contractor 名称",
        "manual_contractor_placeholder": "例如：DSP01",
    ...
    "en": {
        ...
        "manual_hub_label": "Manual name for Unknown Hub",
        "manual_hub_placeholder": "e.g. ONT",
        "manual_contractor_label": "Manual name for Unknown Contractor",
        "manual_contractor_placeholder": "e.g. DSP01",
