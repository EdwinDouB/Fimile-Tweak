...
I18N = {
    "zh": {
        ...
        "metric_delivered_24h": "24小时妥投率",
        "metric_delivered_threshold": "<{threshold}h 妥投率",
        "metric_scan_24h": "24小时上网率",
        "metric_scan_threshold": "<{threshold}h 上网率",
        "metric_lost_rate": "丢包率",
        "chart_delivered_24h": "24小时妥投占比",
        "chart_delivered_threshold": "<{threshold}h 妥投占比",
        "chart_scan_24h": "24小时上网占比",
        "chart_scan_threshold": "<{threshold}h 上网占比",
        "chart_lost": "丢包占比",
        "label_delivered_hit": "<{threshold}h妥投",
        "label_delivered_miss": ">={threshold}h或未妥投",
        "label_scan_hit": "<{threshold}h上网",
        "label_scan_miss": ">={threshold}h或未上网",
        "label_lost_hit": "丢包",
        "label_lost_miss": "未丢包",
        "no_data_for_chart": "{title}：暂无可用数据",
        "delivered_detail_24h": "24小时妥投率明细",
        "section_delivered_rate": "24/48/72 小时妥投率（上网 -> 妥投）",
        "section_scan_rate": "12/24/48/72 小时上网率（提货 -> 上网）",
        "section_monthly_lost": "月丢包率（Last Scan 后 120h 内无后续轨迹，且排除未满 120h 运单）",
        "monthly_lost_metric_name": "整体月丢包率口径",
        "section_damage_reserved": "月破损率（预留）",
        "section_intercept_reserved": "拦截成功率（预留）",
        "reserved_damage_info": "预留区域：月破损率指标待后续开发。",
        "reserved_intercept_info": "预留区域：拦截成功率指标待后续开发。",
        "line_count_col": "包裹总数",
        "line_eval_col": "评价重量",
        "db_env_missing": "MySQL 环境变量未配置：{fields}",
        "missing_pymysql": "缺少依赖 pymysql。请先 pip install pymysql",
    },
    "en": {
        "language_label": "语言 / Language",
        ...
        "metric_delivered_24h": "24h Delivery Rate",
        "metric_delivered_threshold": "<{threshold}h Delivery Rate",
        "metric_scan_24h": "24h Scan Rate",
        "metric_scan_threshold": "<{threshold}h Scan Rate",
        "metric_lost_rate": "Lost Rate",
        "chart_delivered_24h": "24h Delivery Share",
        "chart_delivered_threshold": "<{threshold}h Delivery Share",
        "chart_scan_24h": "24h Scan Share",
        "chart_scan_threshold": "<{threshold}h Scan Share",
        "chart_lost": "Lost Share",
        "label_delivered_hit": "Delivered <{threshold}h",
        "label_delivered_miss": "Delivered >={threshold}h or not delivered",
        "label_scan_hit": "Scanned <{threshold}h",
        "label_scan_miss": "Scanned >={threshold}h or not scanned",
        "label_lost_hit": "Lost",
        "label_lost_miss": "Not Lost",
        "no_data_for_chart": "{title}: No data available",
        "delivered_detail_24h": "24h Delivery Rate Details",
        "section_delivered_rate": "24/48/72h Delivery Rate (First Scan -> Delivered)",
        "section_scan_rate": "12/24/48/72h Scan Rate (Pickup -> First Scan)",
        "section_monthly_lost": "Monthly Lost Rate (No follow-up scan within 120h after Last Scan, excluding waybills not yet 120h old)",
        "monthly_lost_metric_name": "Overall Monthly Lost Rate",
        "section_damage_reserved": "Monthly Damage Rate (Reserved)",
        "section_intercept_reserved": "Interception Success Rate (Reserved)",
        "reserved_damage_info": "Reserved section: monthly damage rate is pending development.",
        "reserved_intercept_info": "Reserved section: interception success rate is pending development.",
        "line_count_col": "Package Count",
        "line_eval_col": "Evaluation Weight",
        "db_env_missing": "Missing MySQL environment variables: {fields}",
        "missing_pymysql": "Missing dependency pymysql. Please run: pip install pymysql",
    },
}
